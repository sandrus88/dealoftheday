...
insert into contract (ID, CLIENT_FULLNAME, CLIENT_CELL, BROKER_FULLNAME, BROKER_CELL, SIGNED_DATE, START_DATE, END_DATE, IBAN, CONTRACT_COMMENT, PARTNER_ID) values (5, 'Client5', 'Cell Client5', 'Broker5', 'Cell Broker5', TO_DATE('05/01/2020', 'DD/MM/YYYY'), TO_DATE('05/02/2020', 'DD/MM/YYYY'), TO_DATE('05/03/2020', 'DD/MM/YYYY'), 'IT0005', 'Comment about Contract5', 2);

insert into deal (ID, TITLE, TITLE_NEWSLETTER, MAIN_IMG, SYNTHESIS, CONDITIONS, DESCRIPTION, STATUS, CONTRACT_COMMENT, LAST_UPDATE, LAST_UPDATE_USER, APPROVED_DATE, CONTRACT_ID) values (1, 'Hotel Santa Lucia 4 stelle', 'Newsletter Hotel Santa Lucia', 'Img Hotel Santa Lucia', 'Synthesis deal 1', 'Conditions deal 1', 'Description deal 1', 'DEAL_INSERTED', 'Comment about deal 1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TO_DATE('02/01/2021', 'DD/MM/YYYY'), 1);
insert into deal (ID, TITLE, TITLE_NEWSLETTER, MAIN_IMG, SYNTHESIS, CONDITIONS, DESCRIPTION, STATUS, CONTRACT_COMMENT, LAST_UPDATE, LAST_UPDATE_USER, APPROVED_DATE, CONTRACT_ID) values (2, 'Cena per 2', 'Newsletter Cena per 2', 'Img Cena per 2', 'Synthesis deal 2', 'Conditions deal 2', 'Description deal 2', 'DEAL_INSERTED', 'Comment about deal 2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TO_DATE('01/01/2021', 'DD/MM/YYYY'), 2);
insert into deal (ID, TITLE, TITLE_NEWSLETTER, MAIN_IMG, SYNTHESIS, CONDITIONS, DESCRIPTION, STATUS, CONTRACT_COMMENT, LAST_UPDATE, LAST_UPDATE_USER, APPROVED_DATE, CONTRACT_ID) values (3, 'Viaggio per 2 a Capodanno', 'Newsletter Viaggio per 2 a Capodanno', 'Img Viaggio per 2 a Capodanno', 'Synthesis deal 3', 'Conditions deal 3', 'Description deal 3', 'DEAL_APPROVED', 'Comment about deal 3', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TO_DATE('10/02/2021', 'DD/MM/YYYY'), 3);
insert into deal (ID, TITLE, TITLE_NEWSLETTER, MAIN_IMG, SYNTHESIS, CONDITIONS, DESCRIPTION, STATUS, CONTRACT_COMMENT, LAST_UPDATE, LAST_UPDATE_USER, APPROVED_DATE, CONTRACT_ID) values (4, 'Weekend al cinema per 2', 'Newsletter Weekend al cinema per 2', 'Img Weekend al cinema per 2', 'Synthesis deal 4', 'Conditions deal 4', 'Description deal 4', 'DEAL_EDITED', 'Comment about deal 4', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TO_DATE('25/03/2021', 'DD/MM/YYYY'), 4);
insert into deal (ID, TITLE, TITLE_NEWSLETTER, MAIN_IMG, SYNTHESIS, CONDITIONS, DESCRIPTION, STATUS, CONTRACT_COMMENT, LAST_UPDATE, LAST_UPDATE_USER, APPROVED_DATE, CONTRACT_ID) values (5, 'Percorso Benessere per 2', 'Newsletter Percorso Benessere per 2', 'Img Percorso Benessere per 2', 'Synthesis deal 5', 'Conditions deal 5', 'Description deal 5', 'DEAL_APPROVED', 'Comment about deal 5', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TO_DATE('04/05/2021', 'DD/MM/YYYY'), 5);
