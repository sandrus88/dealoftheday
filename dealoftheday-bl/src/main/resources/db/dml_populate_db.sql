...
insert into customer (ID, NAME, SURNAME, BIRTHDATE, EMAIL, PWD, TEL) values (1, 'Sandro', 'Gargano', TO_DATE('03/05/1988', 'DD/MM/YYYY'), 'sandrus88@hotmail.it', 'pwd1', '0601');
insert into customer (ID, NAME, SURNAME, BIRTHDATE, EMAIL, PWD, TEL) values (2, 'Ermal', 'Aliraj', TO_DATE('08/06/1984', 'DD/MM/YYYY'), 'ermalaliraj@gmail.com', 'pwd2', '0602');
insert into customer (ID, NAME, SURNAME, BIRTHDATE, EMAIL, PWD, TEL) values (3, 'Armela', 'Xhaxho', TO_DATE('03/07/1989', 'DD/MM/YYYY'), 'armelaxhaxho@hotmail.com', 'pwd3', '0603');
