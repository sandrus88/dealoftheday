...
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'MI', 'Milano', 45.46427, 9.18951);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'FI', 'Firenze', 43.77925, 11.24626);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'PA', 'Palermo', 38.13205, 13.33561);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'RM', 'Roma', 41.89193, 12.51133);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'TO', 'Torino', 45.07049, 7.68682);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'NA', 'Napoli', 40.85631, 14.24641);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'BA', 'Bari', 41.11148, 16.85540);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'BO', 'Bologna', 44.49381, 11.33875);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'GE', 'Genova', 44.42640, 8.91519);
insert into city (LMD, ID, NAME, LAT, LNG) values (CURRENT_TIMESTAMP, 'AO', 'Aosta',  45.73764, 7.31722);
...
insert into users (LMD, USERNAME, NAME, SURNAME, EMAIL, PWD, ENABLED, LOCKED, FAILED_LOGIN_COUNT) values (CURRENT_TIMESTAMP, 'admin', 'AdminName', 'AdminSurname', 'sandrus88@hotmail.it', 'admin', 1, 1, 0);
insert into users (LMD, USERNAME, NAME, SURNAME, EMAIL, PWD, ENABLED, LOCKED, FAILED_LOGIN_COUNT) values (CURRENT_TIMESTAMP, 'userSandro', 'Sandro', 'Gargano', 'sandro_gargano@hotmail.it', 'sandro88', 1, 1, 0);
insert into users (LMD, USERNAME, NAME, SURNAME, EMAIL, PWD, ENABLED, LOCKED, FAILED_LOGIN_COUNT) values (CURRENT_TIMESTAMP, 'user3', 'User3Name', 'User3Surname', 'user3@gmail.com', 'user3', 1, 1, 0);
insert into users (LMD, USERNAME, NAME, SURNAME, EMAIL, PWD, ENABLED, LOCKED, FAILED_LOGIN_COUNT) values (CURRENT_TIMESTAMP, 'user4', 'User4Name', 'User4Surname', 'user4@hotmail.com', 'user4', 1, 1, 0);
insert into users (LMD, USERNAME, NAME, SURNAME, EMAIL, PWD, ENABLED, LOCKED, FAILED_LOGIN_COUNT) values (CURRENT_TIMESTAMP, 'user5', 'User5Name', 'User5Surname', 'user5@hotmail.it', 'user5', 1, 0, 0);
